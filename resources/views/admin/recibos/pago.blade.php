...
<body>
    ...
    <table width="100%" border="1" cellspacing="0" style="margin-bottom: 5px">
        <tr style="text-align: center">
            ...
            <td width="30%">
                <b style="font-size: 20px">Recibo de Pago</b>
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="5" style="margin-bottom: 5px">
        <tr>
            ...
            <td rowspan="3" width="100px">{!!QrCode::size(100)->generate('Recibo de Pago #'.$numero_recibo.': '.$recepcion[0]->afiliado->nombre_completo.' en fecha '.$recepcion[0]->created_at) !!}</td>
        </tr>
        <tr>
