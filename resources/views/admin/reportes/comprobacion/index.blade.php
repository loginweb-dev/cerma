...
@section('page_header')
    <h1 class="page-title">
        <i class="voyager-documentation"></i> Balance de Comprobacion de Sumas y Saldos
    </h1>
@stop
                        ...
                        <div class="row">
                            ...
                            <div class="tab-content">
                                <div id="list" class="tab-pane fade in active">
                                    <form id="form-generate" name="form" method="POST" action="{{ url('admin/reports/comprobacion/list') }}" class="form-inline">
                                        @csrf
