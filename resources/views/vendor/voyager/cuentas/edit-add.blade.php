                    ...
                    <form role="form"
                        ...
                        <div class="panel-footer">
                            @section('submit-buttons')
                                ...
                                <a onclick="save_subcuenta()" class="btn btn-primary save">{{ __('voyager::generic.save') }}</a>
...
@section('javascript')
    ...
    <script>
        ...
        // async function save_cuenta(codigo) {

        //     var midata={
        //         nombre:$("input[name='nombre']").val(),
        //         detalles: $("input[name='detalles']").val(),
        //         plan_de_cuenta_id: $("input[name='plan_de_cuenta_id']").val(),
        //         codigo: codigo

        //     }
        // }
        async function save_subcuenta() {
            var midata={
